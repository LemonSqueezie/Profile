...
public class MinimaxAI extends AIModule
{
    ...
    // For each possible move, determine how many in-a-rows you can make
    // in all 4 directions. Sum them up and do the same thing for other
    // player. Subtrac the total sum between players.
    int evaluation2(final GameStateModule state)
    {
